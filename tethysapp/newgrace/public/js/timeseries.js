...
//          if ($("#select_storage_type").find('option:selected').val()=="http://localhost:8080/thredds/wms/testAll/grace/GRC_tot.25scaled.nc"){
    ...
    addPositionMarker: function(point) {
        ...
        if(this._baseLayer.getURL()=="http://128.187.106.141:7000/thredds/wms/testAll/grace/GRC_tot.25scaled.nc"){
    ...
    _loadData: function(latlng,doall, callback) {
	    ...
	    if(doall==1){
	    //total water
	        var url="http://128.187.106.141:7000/thredds/wms/testAll/grace/GRC_jpl_tot.nc?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetFeatureInfo&CRS=CRS:84";
	    }
	    if(doall==2){
	    //surface water
	        var url="http://128.187.106.141:7000/thredds/wms/testAll/grace/GRC_jpl_sw.nc?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetFeatureInfo&CRS=CRS:84";
	        }
	    if(doall==3){
	        //soil moisture
	        var url="http://128.187.106.141:7000/thredds/wms/testAll/grace/GRC_jpl_soil.nc?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetFeatureInfo&CRS=CRS:84";
	    }
	    if(doall==4){
	        //groundwater
	        var url="http://128.187.106.141:7000/thredds/wms/testAll/grace/GRC_jpl_gw.nc?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetFeatureInfo&CRS=CRS:84";
	        }
